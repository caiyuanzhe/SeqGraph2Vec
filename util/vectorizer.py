...
class SeqVectorizer(BaseVectorizer):
    ...
    def train(self, sentences: List[str], vector_size: int = 128):
        """ 
            Note that mode of 'mean_concat_max_pool' is only recommended for short sequences (e.g., 150bp segments).
        """
